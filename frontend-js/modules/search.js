        ...
        if (posts.length) {
            this.resultsArea.innerHTML = DOMPurify.sanitize(`
                <div class="list-group shadow-sm">
                    <div class="list-group-item active"><strong>Search Results</strong>: (${posts.length > 1
            ...
            this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">Sorry, We Couldn't Find any Search Results For That Search .. Please Try Again</p>`
        };
        this.hideLoaderIcon();
