...
Follow.prototype.validate = async function (action) {
  ...
  if (action == "create") {
    if (doesFollowAlreadyExist)
      this.errors.push("You're Already Following This User");
  }
  if (action == "delete") {
    if (!doesFollowAlreadyExist)
      this.errors.push("You Can't Following Someone You don't Already Follow");
  }

  // Avoid Follow Your self
  if (this.followedId.equals(this.authorId))
    this.errors.push("You Can't Follow Your Self");
};
